/* Automatically generated by
	VMPluginCodeGenerator * VMMaker-eem.592 uuid: 2fd01d00-ff76-4853-be25-c5467d0a665e
   from
	CroquetPlugin * VMMaker-eem.592 uuid: 2fd01d00-ff76-4853-be25-c5467d0a665e
 */
static char __buildInfo[] = "CroquetPlugin * VMMaker-eem.592 uuid: 2fd01d00-ff76-4853-be25-c5467d0a665e " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"CroquetPlugin * VMMaker-eem.592 (i)"
#else
	"CroquetPlugin * VMMaker-eem.592 (e)"
#endif
;
...
primitiveOptimizeVertexIndicesForCacheLocality(void) {
	...
	if (!(interpreterProxy->isWords(indicesOop))) {
		return interpreterProxy->primitiveFail();
	}
...
void* CroquetPlugin_exports[][3] = {
	...
	{"CroquetPlugin", "primitiveOptimizeVertexIndicesForCacheLocality", (void*)primitiveOptimizeVertexIndicesForCacheLocality},
