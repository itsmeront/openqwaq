...
char *	getDefaultSoundPlayer() { 
	getNumberOfSoundPlayerDevices();  // cause device-list to be repopulated with fresh data
...
char *	getDefaultSoundRecorder() { 
	getNumberOfSoundRecorderDevices();  // cause device-list to be repopulated with fresh data
...
static void setDefaultDevice(char *deviceName, Boolean isInput, AudioHardwarePropertyID propertyID)
{
	...
	AudioObjectPropertyAddress propAddress = {	propertyID,
												kAudioObjectPropertyScopeGlobal,
												kAudioObjectPropertyElementMaster };
	OSStatus err = AudioObjectSetPropertyData(	kAudioObjectSystemObject,
												&propAddress,
												0,
												NULL,
												sizeof(deviceID),
