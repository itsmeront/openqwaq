...
int primitivePluginCommandFromBrowser(void);
int primitivePluginCommandToBrowser(void);
...
void *os_exports[][3] = {
  ...
  {"","primitivePluginCommandFromBrowser", primitivePluginCommandFromBrowser},
  {"","primitivePluginCommandToBrowser", primitivePluginCommandToBrowser},
  {"", "printf", printf},
  {"","stWindow", &stWindow},
