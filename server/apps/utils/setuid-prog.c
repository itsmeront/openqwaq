/*
  This file was grabbed from the Python 2.5.1 source distribution; 
  the file itself hasn't changed since the 90s.  Other than this 
  attribution text, the file is unmodified.  

  This code is covered by the Python Software Foundation license, 
  which may be viewed at: http://www.python.org/psf/licence.html
*/
